...
def tune_random_forest(X_train, X_test, y_train, y_test):
    """Performs hyperparameter tuning for Random Forest using GridSearchCV (Local evaluation only)."""
    ...
    print("\nTuned Random Forest Evaluation Metrics (Local Check):")
...
if __name__ == "__main__":
    ...
    # Tune and evaluate Random Forest model locally
    model, metrics = tune_random_forest(X_train, X_test, y_train, y_test)
    
    print("\nTuning evaluation completed successfully! (No model saved to registry)")